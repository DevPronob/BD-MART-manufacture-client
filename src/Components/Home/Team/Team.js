  ...
  return (
    <div>
      <div class="mb-16">
        ...
        <div class="w-full  px-10 pb-10 pt-[40px]">
          <div class="container mx-auto">
            ...
            >
              ...
              <div
                ...
                class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5"
              >
                <div class="rounded overflow-hidden shadow-xl bg-white">
                  <div class="absolute -mt-20 w-full flex justify-center">
                    <div class="h-32 w-32">
                      <img
                        src="https://demo.casethemes.net/induxe/wp-content/uploads/2019/10/pic1.jpg"
              ...
              >
                <div class="rounded overflow-hidden shadow-md bg-white">
                  <div class="absolute -mt-20 w-full flex justify-center">
                    <div class="h-32 w-32">
                      <img
                        src="https://demo.casethemes.net/induxe/wp-content/uploads/2019/10/pic2.jpg"
              ...
              >
                <div class="rounded overflow-hidden shadow-md bg-white">
                  <div class="absolute -mt-20 w-full flex justify-center">
                    <div class="h-32 w-32">
                      <img
                        src="https://demo.casethemes.net/induxe/wp-content/uploads/2019/10/pic4.jpg"

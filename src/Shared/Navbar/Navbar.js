...
<header class="mb-2 px-4 shadow">
  <div class="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
      ...
      <li><Link className='text-gray-600 hover:text-blue-600' to="/tools">Tools</Link></li>
      ...
      {/* <li><Link to="/signUp">SignUp</Link></li> */}
      {
        user && <li><Link className='text-gray-600 hover:text-blue-600' to="/dashboard">Dashboard</Link></li>
      }
      ...
      {user ? <label for="my-drawer-2" class="btn btn-primary drawer-button lg:hidden">Open drawer</label>:""}
